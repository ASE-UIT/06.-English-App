...
const dataForCourseItem = [
    {
        srcImg: 'https://images.unsplash.com/photo-1728996152930-233c5aca21d7?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwzfHx8ZW58MHx8fHx8',
        title: 'TOEIC',
    ...
    <ScrollView className='w-full px-[24px] py-6'>
        ...
        <View className='w-full flex flex-row items-center justify-between'>
            <Button title='All' type={buttonSelected === 'All' ?  'solid' : 'outline'} className='rounded-[30px] px-3 py-[14px]' buttonStyle={{backgroundColor: buttonSelected === 'All' ? '#EF5DA8' : 'transparent'}} titleStyle={{color: buttonSelected === 'All' ? '#ffffff' : '#000000'}}
                    onPress={() => setButtonSelected('All')}></Button>
            <Button title='In progress' type={buttonSelected === 'In progress' ?  'solid' : 'outline'} className='rounded-[30px] px-3 py-[14px]' buttonStyle={{backgroundColor: buttonSelected === 'In progress' ? '#EF5DA8' : 'transparent'}} titleStyle={{ color: buttonSelected === 'In progress' ? '#ffffff' : '#000000'}}
                    onPress={() => setButtonSelected('In progress')}></Button>
            <Button title='Finished' type={buttonSelected === 'Finished' ?  'solid' : 'outline'} className='rounded-[30px] px-3 py-[14px]' buttonStyle={{backgroundColor: buttonSelected === 'Finished' ? '#EF5DA8' : 'transparent',}} titleStyle={{color: buttonSelected === 'Finished' ? '#ffffff' : '#000000'}}
                    onPress={() => setButtonSelected('Finished')}></Button>
